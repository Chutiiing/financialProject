...
if __name__ == "__main__":
    ...
    dm = DataManager(
        save_path="/root/autodl-tmp/.qlib/tmp",
        qlib_export_path="/root/autodl-tmp/.qlib/qlib_data/cn_data_rolling",
        qlib_base_data_path="/root/autodl-tmp/.qlib/qlib_data/cn_data",
